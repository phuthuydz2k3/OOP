...
public class Aims
{
    ...
    {
        store.printMedia();
        System.out.print("1. Add a hust.soict.dsai.aims.media to the store\n2. Remove a hust.soict.dsai.aims.media from the store\n0. Back\nEnter 0-1-2: ");
        int place = 3;
    ...
    private static void cartMenu()
    {
        ...
        System.out.println("3. Remove hust.soict.dsai.aims.media from cart");
        System.out.println("4. Play a hust.soict.dsai.aims.media");
    ...
    private static void storeMenu()
    {
        System.out.println("Options: ");
        System.out.println("-------------------------------");
        System.out.println("1. See a hust.soict.dsai.aims.media's details");
        System.out.println("2. Add a hust.soict.dsai.aims.media to cart");
        System.out.println("3. Play a hust.soict.dsai.aims.media");
